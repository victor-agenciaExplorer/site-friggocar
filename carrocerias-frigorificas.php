...
<title>Friggocar – Carrocerias Frigoríficas</title>
<meta name="description" content="Carrocerias Frigoríficas com tecnologia exclusiva italiana para atender às principais necessidades do mercado brasileiro. Confira!">
</head>
            ...
            <div class="container text-center text-lg-start">
                <div class="banner-internal-content-wrapper offset-lg-1">
                    <ul class="breadcrumb d-flex justify-content-center justify-content-lg-start gap-1">
                        ...
                        <li><a href="carrocerias-frigorificas.php">Carroceria Frigorífica</a></li>
                    </ul>
        ...
        <section class="container-lg pt-5 mt-4">
            <div class="row justify-content-lg-between">
                ...
                <div class="pt-5 pt-lg-0 col-lg-5">
                    ...
                    <a href="contato.php" role="button" class="btn base-button">Saiba mais sobre as carrocerias frigorificas da
                        Friggocar</a>
                </div>
            </div>
        </section>
