    ...
    <div class="container text-center text-lg-start">
        <div class="banner-internal-content-wrapper offset-lg-1">
            <ul class="breadcrumb d-flex justify-content-center justify-content-lg-start gap-1">
                ...
                <li><a href="template-carrocerias.php">Carroceria Frigorífica</a></li>
            </ul>
            ...
            <p class="subtitle text-lg-start">A escolha nº1 do sorveteiro</p>
        </div>
    </div>
</section>
...
<section class="advantages d-flex flex-column flex-lg-row justify-content-center align-items-center gap-4">
    <div class="advantage d-flex align-items-center justify-content-center gap-2">
        <img src="assets/images/icon-4.svg" alt="" class="img-fluid">
        <p class="smaller">
    ...
    <div class="advantage d-flex align-items-center justify-content-center gap-2">
        <img src="assets/images/icon-5.svg" alt="" class="img-fluid">
        <p class="smaller">
            Leve e resistente
        </p>
    </div>
    ...
    <div class="advantage d-flex align-items-center justify-content-center gap-2">
        <img src="assets/images/icon-6.svg" alt="" class="img-fluid">
        <p class="smaller">
            100% personalizável
        </p>
    </div>
...
<main id="refrigerated-bodies" class="refrigerated-bodies container">
    <section class="container-lg pt-5 mt-4">
        <div class="row justify-content-lg-between">
            ...
            <div class="pt-5 pt-lg-0 col-lg-5">
                ...
                <a href="" role="button" class="btn base-button">Saiba mais sobre as carrocerias frigorificas da
                    Friggocar</a>
            </div>
        </div>
    </section>
    ...
    <section class="container-lg pt-5 mt-4">
        <div class="row justify-content-lg-between">
            <div class="col-lg-6 justify-content-center d-flex d-lg-block order-lg-last">
                <img src="assets/images/friggocar-truck-with-bg.png" alt="" class="img-fluid">
            </div>
            ...
            <div class="pt-5 pt-lg-0 col-lg-5">
                ...
                <a href="" role="button" class="btn base-button">
    ...
    <section class="d-lg-flex flex-lg-column py-4 my-4">
