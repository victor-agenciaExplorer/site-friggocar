...
<main id="home">
    ...
    <section class="container pt-5">
        ...
        <a href="#about-us" class="btn base-button cta-cards mt-5" role="button">Quero saber mais</a>
    </section>
    ...
    <section id="about-us" class="d-lg-flex container-lg-fluid pt-5 mt-4 about-us overflow-hidden">
        <div class="row">
            <div class="py-5 px-5 offset-lg-1 col-lg-5">
                ...
                <a href="#products" role="button" class="btn base-button">
                    Conheça agora nossos produtos e serviços
                </a>
            </div>
        ...
        <div class="carousel-products row">
            <div class="product--first col-lg">
                <div class="product-wrapper">
                    ...
                    <p>Carrocerias de até 7m personalizadas para o seu negócio.</p>


                    <ul class="mt-3">
                        <li>Baú Sorveteiro</li>
                    </ul>
            ...
            <div class="product--second col-lg">
                <div class="product-wrapper">
                    ...
                    <ul class="mt-3">
                        <li>Matéria-prima de alta qualidade </li>
                        <li>Melhor custo x benefício do mercado</li>
                        <li>Fabricada em aço-inox 304L a prova de corrosão</li>
                    </ul>
